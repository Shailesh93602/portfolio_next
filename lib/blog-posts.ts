...
export const blogPosts: BlogPost[] = [
  {
    ...
    description:
      "Follow my journey of solving over 700 Data Structures and Algorithms problems. Learn about my strategies, challenges, and key insights that helped me improve my problem-solving skills.",
  ...
  },
  {
    ...
    description:
      "Join me as I share the most valuable lessons and insights from my first year as a software engineer. From technical challenges to professional growth, discover practical tips for success.",
  ...
  },
  {
    ...
    description:
      "Follow my journey from a passionate coding intern to a full-time software engineer. Learn about the challenges, growth strategies, and valuable insights I gained along the way.",
