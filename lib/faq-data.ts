...
export const portfolioFaq = (count: number): FaqItem[] => [
  ...
  },
  {
    question: "Where can I see Shailesh Chaudhari's code?",
    answer:
      "Most projects are open-source on GitHub at https://github.com/Shailesh93602. Notable public repos: CodeSenseiSearch, devscale (EduScale), grounded, idempotency-kit, promptproof, devtrack. KhataGO and ContextQA's Vibe Testing / AxeTos are proprietary or private.",
  },
  {
