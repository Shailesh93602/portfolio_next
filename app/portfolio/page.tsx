...
import { portfolioFaq, faqToSchema } from "@/lib/faq-data";
...
const faqItems = portfolioFaq(projects.length);
...
export default function Projects() {
  return (
    <>
      ...
      <PortfolioContent />
      <FAQSection
        title="Questions about these projects"
        description="Quick answers to what most recruiters and engineering managers ask first."
        items={faqItems}
      />
    </>
  );
